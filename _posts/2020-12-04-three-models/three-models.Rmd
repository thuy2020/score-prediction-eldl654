...
show_best(dt_tune_fit2, metric = "rmse") # hoorayy, we got a tiny bit smaller. rmse = 100.0423. Life is hard, just accept it for now. 
...
final_fit_dt$.metrics[[1]] # humm, why rmse still 103?? That's cheating!
...
bag_mod_tune <- bag_tree() %>% 
  ...
  set_engine("rpart", times = 10) # you will almost surely need more than 10
